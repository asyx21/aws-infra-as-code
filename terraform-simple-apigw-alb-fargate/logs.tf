...
# data "aws_iam_policy_document" "log_management" {
#   statement {
#     actions = [
#       "logs:PutLogEvents",
#       "logs:GetLogEvents",
...
#     resources = ["arn:aws:logs:${var.region}:*:log-group:/ecs/${terraform.workspace}-${var.app_name}:log-stream:*"]
#   }
# }

# resource "aws_iam_policy" "ecs_log_management" {
#   name        = "${terraform.workspace}-${var.app_name}-log-mng"
#   path        = "/"
#   description = "Allow managing to cloudwach log-stream"

#   policy = data.aws_iam_policy_document.log_management.json
# }
...
# resource "aws_iam_role_policy_attachment" "ecs_role_log_management" {
#   role       = aws_iam_role.ecs_task_role.name
#   policy_arn = aws_iam_policy.ecs_log_management.arn
# }
